const rules = [
    ...
    {
        title: "Función de las etiquetas de advertencia",
        icon: "../assets/images/Factores/bloqueo_equipos.png",
    },
    {
        title: "Ubicación de etiquetas de advertencia",
        icon: "../assets/images/Factores/bloqueo_equipos.png",
    },
    {
    ...
    {
        title: "Asiento del operador y Cinturón de seguridad",
        icon: "../assets/images/Factores/equipos_moviles.png",
    },
    {
        title: "Extintores: ubicación y uso",
        icon: "../assets/images/Factores/materiales_peligrosos.png",
    },
    {
        title: "Procedimiento frente a un amago de incendio",
        icon: "../assets/images/Factores/aspectos_basicos.png",
    },
    {
        title: "Placa de capacidades y número de serie",
        icon: "../assets/images/Factores/aspectos_basicos.png",
    },
    {
